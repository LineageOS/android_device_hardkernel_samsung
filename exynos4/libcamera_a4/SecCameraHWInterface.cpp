...
int jpeg_dump(char * out_file_name,void * mem,int size)
{
	//////////////////////////////////////////////////////////////
...
int CameraHardwareSec::pictureThread()
{
    ...
    if (mMsgEnabled & CAMERA_MSG_RAW_IMAGE) {
        ...
        if (mUseInternalISP || !strncmp((const char*)mSecCamera->getCameraSensorName(), "S5K5CAGX", 10)) {
          ...
          //  memcpy((unsigned char *)mThumbnailHeap->base(), (unsigned char *)thumb_addr, mThumbSize);
  			jpeg_dump("/data/jpeg/2048x1536.jpg",jpeg_data,1024*1024*4);
            //memcpy(JpegHeap->data, jpeg_data, JpegImageSize);
			jpeg_dump("/data/jpeg/2048x1536_2.jpg",jpeg_data,1024*1024*4);
			
			// extract original jpeg data
			if (mUseInternalISP || !strncmp((const char*)mSecCamera->getCameraSensorName(), "S5K5CAGX", 10)) {
...
jpeg_dump("/data/jpeg/2048x1536_result.jpg",jpeg_data,1024*1024*6);
